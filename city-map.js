...
(function () {
  ...
  var FOLD = {
    ...
    "preveza/lefkada": "Preveza", "aktion": "Preveza",
  ...
  function draw(host, city, origin, partners) {
    ...
    ,
      dragging: (window.matchMedia && window.matchMedia('(pointer: coarse)').matches) ? false : true,
      tap: false});
